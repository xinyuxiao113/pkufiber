...
# 启动训练脚本并保存日志
python -m scripts.train_class --config experiments/$EXPERIMENT_NAME/config.yaml --log_path $log_path --model_path $model_path | tee experiments/$EXPERIMENT_NAME/logs/train.log
