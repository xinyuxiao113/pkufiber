...
from pkufiber.dsp.nonlinear_compensation.pbc import EqStftPBC
...
if __name__ == "__main__":
    ...
    model = EqFreqDBP(Nmodes=2, step=5, dtaps=1001, ntaps=41, rho=0.1)
    y = model(x, task_info)
    print(y.shape)
    # print(model.rmps())
