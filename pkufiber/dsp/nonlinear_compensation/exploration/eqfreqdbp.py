...
class EqFreqPbcDBP(nn.Module):
    ...
    def __init__(self, Nmodes, step, dtaps=2001, ntaps=401, rho=1.0, ol = 40, strides=161, n_share=True, Fs=80e9, D=16.5, Fc: float = 299792458 / 1550e-9, Fi: float = 299792458 / 1550e-9, L=2000e3, gamma=0.0016567):
        super(EqFreqPbcDBP, self).__init__()
        self.Nmodes = Nmodes
        self.step = step
        self.Fs = Fs
        self.D = D 
...
class EqFreqAMPbcDBP(nn.Module):
    """
    PBC equalizer.
    M: int, default=41, the length of the filter.
    rho: float, default=1, the parameter of the filter.
    ...
    def __init__(self, Nmodes, step, dtaps=2001, ntaps=401, rho=1.0, ol = 40, strides=161, n_share=True, Fs=80e9, D=16.5, Fc: float = 299792458 / 1550e-9, Fi: float = 299792458 / 1550e-9, L=2000e3, gamma=0.0016567):
        super(EqFreqAMPbcDBP, self).__init__()
        self.Nmodes = Nmodes
        self.step = step
        self.Fs = Fs
        self.D = D 
...
if __name__ == "__main__":
    ...
    model = EqFreqPbcDBP(Nmodes=2, step=5, dtaps=1001, ntaps=41, rho=0.1)
    y = model(x, task_info)
    print(y.shape)
    # print(model.rmps())
