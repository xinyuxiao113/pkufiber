...
from pkufiber.dsp.nonlinear_compensation.pbc import EqAMPBCstep
...
class EqPbcDBP(nn.Module):
    ...
    def __init__(self, Nmodes, step, dtaps=2001, ntaps=401, rho=1.0, n_share=True, Fs=80e9, D=16.5, Fc: float = 299792458 / 1550e-9, Fi: float = 299792458 / 1550e-9, L=2000e3, gamma=0.0016567):
        super(EqPbcDBP, self).__init__()
        self.Nmodes = Nmodes
        self.step = step
        self.Fs = Fs
        self.D = D 
...
if __name__ == "__main__":
    ...
    model = EqPbcDBP(Nmodes=2, step=5, dtaps=1001, ntaps=41, rho=0.1)
    y = model(x, task_info)
    print(y.shape)
    # print(model.rmps())
